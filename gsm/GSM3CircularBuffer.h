...
#define __BUFFERSIZE__ 256
#define __BUFFERMASK__ 0xFF
...
class GSM3CircularBuffer
{
	private:
		...
		volatile uint8_t head; // First written one
		volatile uint8_t tail; // Last written one.
