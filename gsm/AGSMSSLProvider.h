...
*/
#ifndef __GSMSSLPROVIDER__
#define __GSMSSLPROVIDER__

#include "GSM3MobileClientProvider.h"
#include "GSM3ShieldV1BaseProvider.h"

class GSMSSLProvider : public GSM3MobileClientProvider,  public GSM3ShieldV1BaseProvider
{
	private:
	...
	public:
		...
		*/
		int ready(char c){return GSM3ShieldV1BaseProvider::ready(c);};
